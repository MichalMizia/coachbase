  ...
  return (
    <main className="w-full bg-white py-10 text-gray-800">
      <article className="politykaPrywatnosci privacy-article article flow mx-auto w-[90%] !max-w-7xl lg:w-[85%]">
        <h1 className="!mt-0 mb-8">Polityka prywatności</h1>
        <hr className="mb-2" />
        <span className=" text-h4 font-semibold text-gray-800">
        ...
        <hr className="mt-2" />
        <div className="flow">
          <h2 className="">1. Informacje ogólne</h2>
          <ol>
            <li>
              Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod
              adresem url: <b>coachbase.pl</b>
            </li>
            <li>
          ...
          <h2 className="">5. Informacje w formularzach</h2>
          <ol>
            <li>
          ...
          <h2 className="">6. Logi Administratora</h2>
          <ol>
            <li>
          ...
          <h2 className="">7. Istotne techniki marketingowe</h2>
          <ol>
            <li>
          ...
          <h2 className="">8. Informacja o plikach cookies</h2>
          <ol>
