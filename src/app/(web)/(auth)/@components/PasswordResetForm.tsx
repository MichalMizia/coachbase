...
type FormData = z.infer<typeof pwdResetSchema>;
...
export function PasswordResetForm({
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      const res = await axios.post("/api/profil/nowe-haslo", {
        userId: userId,
      ...
      return toast.error("Nie udało się zmienić hasła");
    } finally {
      setIsLoading(false);
    }
  }
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Button
          ...
          type="button"
          className="mx-auto w-full max-w-sm cursor-not-allowed"
